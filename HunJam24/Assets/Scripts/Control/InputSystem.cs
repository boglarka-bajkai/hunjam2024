...
namespace Control.Input
{
    public class InputSystem : MonoBehaviour
    {
        public void OnTap(InputAction.CallbackContext context)
        {
            ...
            var ray = Physics2D.GetRayIntersectionAll(Camera.main.ScreenPointToRay(Touchscreen.current.primaryTouch.position.ReadValue()));
            ...
            {
                Debug.LogError("No player but in game!");
